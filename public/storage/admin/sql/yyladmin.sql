...
) ENGINE = MyISAM AUTO_INCREMENT = 290 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '日志' ROW_FORMAT = Dynamic;
...
INSERT INTO `yyl_admin_menu` VALUES (12, 2, '个人中心', 'admin/AdminUsers/users', 199, '0', '0', 0, NULL, '2020-07-21 15:36:07', NULL);
...
INSERT INTO `yyl_admin_menu` VALUES (37, 58, '生成随机字符', 'admin/AdminTool/randomStr', 200, '0', '0', 0, NULL, '2020-07-21 15:36:25', NULL);
INSERT INTO `yyl_admin_menu` VALUES (38, 58, '时间戳转换', 'admin/AdminTool/timestamp', 200, '0', '0', 0, NULL, '2020-07-21 15:36:24', NULL);
INSERT INTO `yyl_admin_menu` VALUES (39, 58, 'MD5加密', 'admin/AdminTool/md5Enc', 200, '0', '0', 0, NULL, '2020-07-21 15:36:22', NULL);
INSERT INTO `yyl_admin_menu` VALUES (40, 58, '生成二维码', 'admin/AdminTool/qrcode', 200, '0', '0', 0, NULL, '2020-07-21 15:36:21', NULL);
...
INSERT INTO `yyl_admin_menu` VALUES (45, 12, '个人信息', 'admin/AdminUsers/usersInfo', 200, '0', '0', 0, NULL, '2020-07-21 15:36:08', NULL);
...
INSERT INTO `yyl_admin_menu` VALUES (48, 12, '更换头像', 'admin/AdminUsers/usersAvatar', 200, '0', '0', 0, NULL, '2020-07-21 15:36:10', NULL);
INSERT INTO `yyl_admin_menu` VALUES (49, 1, '控制台', 'admin/AdminIndex/index', 200, '0', '0', 0, NULL, '2020-07-21 15:36:31', NULL);
INSERT INTO `yyl_admin_menu` VALUES (50, 36, '地图坐标拾取', 'admin/AdminTool/mapPoint', 150, '0', '0', 0, NULL, '2020-07-21 15:36:19', NULL);
INSERT INTO `yyl_admin_menu` VALUES (51, 12, '登录', 'admin/AdminLogin/login', 200, '0', '0', 0, NULL, '2020-07-21 15:36:11', NULL);
INSERT INTO `yyl_admin_menu` VALUES (52, 12, '退出', 'admin/AdminLogin/logout', 200, '0', '0', 0, NULL, '2020-07-21 15:36:12', NULL);
INSERT INTO `yyl_admin_menu` VALUES (53, 2, '系统设置', 'admin/AdminSetting/setting', 198, '0', '0', 0, NULL, '2020-07-21 15:36:14', NULL);
INSERT INTO `yyl_admin_menu` VALUES (54, 12, '日志记录', 'admin/AdminUsers/usersLog', 200, '0', '0', 0, NULL, '2020-07-21 15:36:16', NULL);
INSERT INTO `yyl_admin_menu` VALUES (58, 36, '使用工具合集', 'admin/AdminTool/tools', 200, '0', '0', 0, NULL, '2020-07-21 15:36:26', NULL);
INSERT INTO `yyl_admin_menu` VALUES (56, 1, '访问量', 'admin/AdminIndex/visit', 200, '0', '0', 0, NULL, '2020-07-21 15:36:30', NULL);
...
-- ----------------------------
INSERT INTO `yyl_admin_rule` VALUES (1, '1,59', '管理员', '', 200, '1', 0, NULL, '2020-07-21 15:20:36', NULL);
INSERT INTO `yyl_admin_rule` VALUES (2, '0', '技术', '', 200, '1', 0, NULL, '2020-07-21 15:20:36', NULL);
INSERT INTO `yyl_admin_rule` VALUES (3, '0', '产品', '', 200, '1', 0, NULL, '2020-07-21 15:20:37', NULL);
INSERT INTO `yyl_admin_rule` VALUES (4, '0', '操作', '', 200, '1', 0, NULL, '2020-07-21 15:20:38', NULL);
INSERT INTO `yyl_admin_rule` VALUES (5, '1,2,3,4,5,12,13,17,22,36,37,38,39,40,41,42,45,49,50,51,52,54,56,58', '客服', '', 200, '1', 0, NULL, '2020-07-21 15:20:39', NULL);
INSERT INTO `yyl_admin_rule` VALUES (25, '1,13,17,22,36,37,38,39,40,42,45,49,50,51,52,53,54,56,58', '演示', '', 200, '1', 0, NULL, '2020-07-21 15:20:40', NULL);
...
CREATE TABLE `yyl_admin_user`  (
  ...
  `login_ip` varchar(16) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT '' COMMENT '登录IP',
...
-- ----------------------------
INSERT INTO `yyl_admin_user` VALUES (1, '', NULL, 'skyselang', 'skyselang', 'e10adc3949ba59abbe56e057f20f883e', '', 'storage/adminuser/1/avatar.jpg?t=20200612222621', '超级管理员', 200, '0', '0', 0, 3, '127.0.0.1', '2020-07-21 16:45:44', NULL, NULL, NULL, NULL);
INSERT INTO `yyl_admin_user` VALUES (2, '25', NULL, 'yyladmin', 'yyladmin', 'e10adc3949ba59abbe56e057f20f883e', '', 'static/img/favicon.ico', '演示账号', 200, '0', '0', 0, 16, '127.0.0.1', '2020-07-21 17:46:11', '2020-07-21 16:45:38', NULL, '2020-07-21 16:12:57', NULL);
...
INSERT INTO `yyl_admin_user` VALUES (7, '0,25', NULL, 'admin', 'admin', 'e10adc3949ba59abbe56e057f20f883e', '', 'static/img/favicon.ico', '演示账号', 200, '0', '0', 0, 10, '127.0.0.1', '2020-07-21 16:57:09', '2020-07-21 17:06:55', NULL, NULL, NULL);

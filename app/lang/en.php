...
return [
  ...
  '字符，验证码内容' => 'Characters, captcha content',
  '行为，验证码内容' => 'Behavior, captcha content',
  '验证码内容' => 'Captcha content',
  '验证码是否开启' => 'Is the captcha enabled',
  ...
  '通告管理' => 'Notice management',
  '协议管理' => 'Accord management',
  '友链管理' => 'Link management',
  ...
  '日志管理' => 'Log',
  '应用代码，也可以放在请求参数' => 'Application code, can also be placed in the request parameters',
];

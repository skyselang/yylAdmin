...
class ProjectValidate extends Validate
{
    ...
    protected $scene = [
        'info'   => ['project_id'],
        'add'    => ['name', 'content'],
        'edit'   => ['project_id', 'name', 'content'],
        'dele'   => ['project'],
        'istop'  => ['project', 'is_top'],
        'ishot'  => ['project', 'is_hot'],
        'isrec'  => ['project', 'is_rec'],
        'ishide' => ['project', 'is_hide'],
        'image'  => ['image'],
        'video'  => ['video'],
        'file'   => ['file'],
    ...
    protected function checkSort($value, $rule, $data = [])
    {
        ...
        $field_exist = ProjectService::tableFieldExist($sort_field);
        if (!$field_exist) {

...
class ArticleModel extends Model
{
    ...
    /**
     * @Field("article_id,name,article_category_id,sort,hits,is_top,is_hot,is_rec,is_hide,create_time,update_time")
    ...
    /**
     * @Field("article_category_id,name,title,,keywords,description,content,sort")
     */
    public function add()
    {
    }
    ...
    /**
     * @Field("article_id,article_category_id,name,title,,keywords,description,content,sort")
     */
    ...
    /**
     * @Field("article_id,name,article_category_id")
     * @AddField("article_id", type="int", require=false, default="", desc="id")
     * @AddField("name", type="string", require=false, default="", desc="名称")
     * @AddField("article_category_id", type="int", require=false, default="", desc="分类id")
     */
    ...
    /**
     * @Field("name,article_category_id")
     * @AddField("name", type="string", require=false, default="", desc="名称")
     * @AddField("article_category_id", type="int", require=false, default="", desc="分类id")
     */

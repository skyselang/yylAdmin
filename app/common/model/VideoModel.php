...
class VideoModel extends Model
{
    ...
    /**
     * @Field("video_id,name,video_category_id,sort,hits,is_top,is_hot,is_rec,is_hide,create_time,update_time")
    ...
    /**
     * @Field("video_category_id,name,title,,keywords,description,content,sort")
     */
    public function add()
    {
    }
    ...
    /**
     * @Field("video_id,video_category_id,name,title,,keywords,description,content,sort")
     */
    ...
    /**
     * @Field("video_id,name,video_category_id")
     * @AddField("video_id", type="int", require=false, default="", desc="id")
     * @AddField("name", type="string", require=false, default="", desc="名称")
     * @AddField("video_category_id", type="int", require=false, default="", desc="分类id")
     */

...
class ProductModel extends Model
{
    ...
    /**
     * @Field("product_id,name,product_category_id,sort,hits,is_top,is_hot,is_rec,is_hide,create_time,update_time")
    ...
    /**
     * @Field("product_category_id,name,title,,keywords,description,content,sort")
     */
    public function add()
    {
    }
    ...
    /**
     * @Field("product_id,product_category_id,name,title,,keywords,description,content,sort")
     */
    ...
    /**
     * @Field("product_id,name,product_category_id")
     * @AddField("product_id", type="int", require=false, default="", desc="id")
     * @AddField("name", type="string", require=false, default="", desc="名称")
     * @AddField("product_category_id", type="int", require=false, default="", desc="分类id")
     */

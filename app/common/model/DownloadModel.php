...
class DownloadModel extends Model
{
    ...
    /**
     * @Field("download_id,name,download_category_id,sort,hits,is_top,is_hot,is_rec,is_hide,create_time,update_time")
    ...
    /**
     * @Field("download_category_id,name,title,,keywords,description,content,sort")
     */
    public function add()
    {
    }
    ...
    /**
     * @Field("download_id,download_category_id,name,title,,keywords,description,content,sort")
     */
    ...
    /**
     * @Field("download_id,name,download_category_id")
     * @AddField("download_id", type="int", require=false, default="", desc="id")
     * @AddField("name", type="string", require=false, default="", desc="名称")
     * @AddField("download_category_id", type="int", require=false, default="", desc="分类id")
     */
    ...
    /**
     * @Field("name,download_category_id")
     * @AddField("name", type="string", require=false, default="", desc="名称")
     * @AddField("download_category_id", type="int", require=false, default="", desc="分类id")
     */

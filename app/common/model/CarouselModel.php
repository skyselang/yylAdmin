...
class CarouselModel extends Model
{
    ...
    /**
     * @Field("carousel_id,name,url,sort,is_top,is_hot,is_rec,is_hide,create_time,update_time")
    ...
    /**
     * @Field("carousel_id,name,url,sort")
     */
    ...
    /**
     * @Field("carousel_id,name")
     * @AddField("carousel_id", type="int", require=false, default="", desc="id")

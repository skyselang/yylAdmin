    ...
    public static function server()
    {
        ...
        if (empty($cache)) {
            ...
            if ($config['default'] == 'redis') {
                ...
                $cache['used_memory_lua_human'] = ByteUtils::format($cache['used_memory_lua']);
                ...
                $cache['bytes_read']     = ByteUtils::format($cache['bytes_read']);
                $cache['bytes_written']  = ByteUtils::format($cache['bytes_written']);
                $cache['limit_maxbytes'] = ByteUtils::format($cache['limit_maxbytes']);

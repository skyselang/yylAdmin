...
use app\common\cache\setting\NoticeCache as Cache;
...
class NoticeService
{
    ...
    public static function list($where = [], $page = 1, $limit = 10, $order = [], $field = '', $total = true)
    {
        ...
        if (empty($field)) {
            $field = $pk . ',unique,image_id,type,title,title_color,start_time,end_time,remark,sort,is_disable,create_time,update_time';
        } else {
            $field = $pk . ',' . $field;
        }
    ...
    public static function header($exp_imp = 'import')
    {
        ...
        $header = [
            ...
            ['field' => $type, 'name' => lang('类型'), 'width' => 10],
            ['field' => $image_id, 'name' => lang('图片'), 'width' => 20],
            ['field' => 'title', 'name' => lang('标题'), 'width' => 26, 'color' => 'FF0000'],
            ['field' => 'title_color', 'name' => lang('标题颜色'), 'width' => 12],
    ...
    public static function export($export_info)
    {
        ...
        $export_info['type']    = FileSettingService::EXPIMP_TYPE_SETTING_NOTICE;

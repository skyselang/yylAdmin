...
use app\common\cache\member\TagCache as Cache;
...
class TagService
{
    ...
    public static function export($export_info)
    {
        ...
        $export_info['type']    = FileSettingService::EXPIMP_TYPE_MEMBER_TAG;
    ...
    {
        if ($is_add) {
            $import_info['type'] = FileSettingService::EXPIMP_TYPE_MEMBER_TAG;
     ...
     */
    public static function memberLift($tag_id, $member_ids = [])
    {

...
class ApidocDefinitions
{
    ...
    /**
     * 字段查询方式返回参数
     * @Apidoc\Returned("exps", type="array", desc="查询方式", children={
     ...
     * @Apidoc\Param("ajcaptcha", type="object", default="", desc="行为，验证码内容", children={
     ...
     * @Apidoc\Returned("repData", type="object", default="", desc="行为，", children={

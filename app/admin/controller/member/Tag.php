...
class Tag extends BaseController
{
     ...
     * @Apidoc\Returned("list", ref="app\common\model\member\TagModel", type="array", desc="标签列表", field="tag_id,tag_name,tag_desc,sort,is_disable,create_time,update_time")
     */
     ...
     * @Apidoc\Title("会员标签添加")
     * @Apidoc\Method("POST")
     * @Apidoc\Param(ref="app\common\model\member\TagModel", field="tag_name,tag_desc,sort")
     */
    public function add()
    {
     ...
     * @Apidoc\Title("会员标签修改")
     * @Apidoc\Method("POST")
     * @Apidoc\Param(ref="app\common\model\member\TagModel", field="tag_id,tag_name,tag_desc,sort")
     */

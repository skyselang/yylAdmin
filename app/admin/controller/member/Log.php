...
use app\common\validate\member\LogValidate as Validate;
use app\common\service\member\LogService as Service;
use app\common\model\member\LogModel as Model;

/**
 * @Apidoc\Title("lang(会员日志)")
 * @Apidoc\Group("log")
 * @Apidoc\Sort("100")
 */

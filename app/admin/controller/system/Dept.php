...
use app\common\validate\system\DeptValidate as Validate;
...
class Dept extends BaseController
{
    ...
    public function edit()
    {
        ...
        $data = $this->service::edit($param['dept_id'], $param);

        return success($data);
    }

    /**
     * @Apidoc\Title("lang(部门删除)")
     * @Apidoc\Method("POST")
